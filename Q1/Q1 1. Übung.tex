...
\begin{figure}[h]
	\centering
		...
		\subfloat[gleichförmige Bewegung]{\input{1_1_gleichfoermige_Bewegung.pdf_tex}\label{Q111gleichfoermigeBewegung}}\hfil
		\def\svgwidth{0.3\textwidth}
		\subfloat[gleichmäßig beschleunigte Bewegung]{\input{1_2_gleichmaessig_beschleunigte_Bewegung.pdf_tex}\label{Q111gleichmaessigBeschleunigteBewegung}}
\end{figure}
