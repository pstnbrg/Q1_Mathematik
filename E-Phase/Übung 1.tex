...
\AbschnittV{1}{Lineare Funktionen}
	\begin{itemize}
	...
	\end{itemize}
\AbschnittV{2}{Quadratische Funktionen}
	\begin{itemize}
...
\AbschnittV{3}{Polynome}
	\begin{itemize}
		...
		\end{equation*}
	\end{itemize}
\Abschnitt{4}{Gemischte Aufgaben Funktionen und Mengen}
...
\Abschnitt{5}{Multiple Choice}
		...
		\end{itemize}
\AbschnittV{6}{Differentialquotient, h-Methode}
	\begin{itemize}
